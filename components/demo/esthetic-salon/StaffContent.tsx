import { estheticStaff } from '@/lib/sample-data-esthetic'

export default function EstheticStaff() {
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl font-bold text-gray-800">スタッフ管理</h1>
        <p className="text-sm text-gray-400 mt-0.5">在籍セラピスト {estheticStaff.length} 名</p>
      </div>
