import { osteoStaff } from '@/lib/sample-data-osteopathic'

export default function OsteopathicStaff() {
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl font-bold text-gray-800">スタッフ管理</h1>
        <p className="text-sm text-gray-400 mt-0.5">在籍スタッフ {osteoStaff.length} 名</p>
      </div>
