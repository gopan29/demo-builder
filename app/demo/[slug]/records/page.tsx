            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 mt-3 flex-wrap">
                  <span className="text-xs text-gray-400">
                    🗓 次回予定: <span className="text-gray-600 font-medium">
                      {new Date(r.next_visit_scheduled).toLocaleDateString('ja-JP', { month: 'long', day: 'numeric' })}
                    </span>
                  </span>
                  <span className="text-xs text-gray-400">
                    💴 料金: <span className="text-gray-600 font-medium">¥{r.price.toLocaleString()}</span>
                  </span>
                </div>
              </div>
              ...
              <div className="text-right flex-shrink-0">
                ...
                <p className="text-xs text-gray-300">
                  {new Date(r.visit_date).toLocaleDateString('ja-JP', { year: 'numeric' })}
                </p>
              </div>
            </div>
          </div>
